...
class NBAScoresFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """Config flow for NBA."""
    ...
    def async_get_options_flow(config_entry):
        return NBAScoresOptionsFlow(config_entry)


class NBAScoresOptionsFlow(config_entries.OptionsFlow):
